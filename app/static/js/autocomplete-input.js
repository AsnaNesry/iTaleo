...
//    $.fn.tagSuggest.defaults = {};
        ...
        $(document).ready(function() {
            var jsonData = [];
            var skills = 'Spring Boot,Core Java,Spring Mvc,Redis,Rest,MySQL,MongoDB,Spring Framework,SOAP,Design Pattern'.split(',');
            for(var i=0;i<skills.length;i++) jsonData.push({id:skills[i],name:skills[i]});
            var key_skills = $('#key_skills').tagSuggest({
                data: jsonData,
                sortOrder: 'name',
                maxDropHeight: 200,
                name: 'key_skills'
            });
            var secondary_skills = $('#secondary_skills').tagSuggest({
                data: jsonData,
                sortOrder: 'name',
                maxDropHeight: 200,
                name: 'secondary_skills'
            });
            var skill_name = $('#skill_name').tagSuggest({
                data: jsonData,
                sortOrder: 'name',
                maxDropHeight: 200,
                name: 'skill_name'
